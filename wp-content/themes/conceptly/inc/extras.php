 ...
 * @return array
 */
function conceptly_body_classes( $classes ) {
...
add_filter( 'body_class', 'conceptly_body_classes' );
...
if (!function_exists('conceptly_str_replace_assoc')) {

    /**
     * conceptly_str_replace_assoc
     * @param  array $replace
     * @param  array $subject
     * @return array
     */
    function conceptly_str_replace_assoc(array $replace, $subject) {
...
add_action( 'wp_ajax_conceptly_business_dismissed_notice_handler', 'conceptly_ajax_notice_handler' );

/**
 * AJAX handler to store the state of dismissible notices.
 */
function conceptly_ajax_notice_handler() {
    if ( isset( $_POST['type'] ) ) {
...
function conceptly_deprecated_hook_admin_notice() {
        ...
        if ( ! get_option('dismissed-get_started', FALSE ) ) {
            ...
            <div class="updated notice notice-get-started-class is-dismissible" data-notice="get_started">
                <div class="conceptly-getting-started-notice clearfix">
                    <div class="conceptly-theme-screenshot">
                        <img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/screenshot.png" class="screenshot" alt="<?php esc_attr_e( 'Theme Screenshot', 'conceptly' ); ?>" />
                    </div><!-- /.conceptly-theme-screenshot -->
                    <div class="conceptly-theme-notice-content">
                        <h2 class="conceptly-notice-h2">
                            <?php
                        printf(
                        /* translators: 1: welcome page link starting html tag, 2: welcome page link ending html tag. */
                            esc_html__( 'Welcome! Thank you for choosing %1$s!', 'conceptly' ), '<strong>'. wp_get_theme()->get('Name'). '</strong>' );
                        ?>
                        </h2>
                        ...
                        ?>
                    </div><!-- /.conceptly-theme-notice-content -->
                </div>
            </div>
        <?php }
}

add_action( 'admin_notices', 'conceptly_deprecated_hook_admin_notice' );

/*******************************************************************************
 *  Plugin Installer
 *******************************************************************************/

add_action( 'wp_ajax_install_act_plugin', 'conceptly_admin_install_plugin' );

function conceptly_admin_install_plugin() {
    /**
     * Install Plugin.
     */
